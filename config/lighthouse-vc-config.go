...
const (
	// Tags
	lighthouseVcTagPortableTest string = "sigp/lighthouse:v5.1.0"
	lighthouseVcTagPortableProd string = "sigp/lighthouse:v5.1.0"
	lighthouseVcTagModernTest   string = "sigp/lighthouse:v5.1.0-modern"
	lighthouseVcTagModernProd   string = "sigp/lighthouse:v5.1.0-modern"
)
